...
/// @title InitializeMissingPools
/// @notice Initialize the wrap pair pools (E and F) on existing FheatherXv6 hook
/// @dev Run with: source .env && forge script script/InitializeMissingPools.s.sol:InitializeMissingPools --rpc-url $ETH_SEPOLIA_RPC --broadcast -vvv
contract InitializeMissingPools is Script {
    using PoolIdLibrary for PoolKey;

    // ============ Ethereum Sepolia Addresses ============
    address constant POOL_MANAGER = 0xE03A1074c86CFeDd5C142C4F04F1a1536e203543;

    // Existing FheatherXv6 Hook
    address constant HOOK = 0x1e2F7C494fe1C34dD7Bc8E389eF4e922288c90C8;
