# PheatherX Test Wallet

A dedicated test wallet for PheatherX development. This wallet is separate from the standard Anvil accounts to avoid confusion.
...
# Mint test tokens (run after deploying MockPheatherX)
