...
function HookAddressBadge() {
  ...
  if (isLoading) {
    return (
      <div className="flex items-center gap-1.5 px-2 py-1 rounded-md bg-carbon-gray/50 border border-carbon-gray text-xs">
        <span className="text-steel-gray">Loading...</span>
      </div>
    );
  }
